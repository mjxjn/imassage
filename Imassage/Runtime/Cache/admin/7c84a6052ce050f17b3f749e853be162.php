...
<title>登录页面_Imassage后台管理系统模板</title>
...
<script type="text/javascript" src="/AmaAdmin/js/custom/index.js"></script>
<!--[if IE 9]>
	...
	<div class="loginbox">
    	<div class="loginboxinner">
            ...
            <div class="nopassword">
				<div class="loginmsg">密码不正确.</div>
                <div class="loginf">
                    <div class="thumb"><img alt="" src="/AmaAdmin/images/thumbs/avatar1.png" /></div>
            ...
            <form id="login" action="<?php echo U('Index/index');?>" method="post">
