    ...
    <div id="contentwrapper" class="contentwrapper">
    	<div id="basicform" class="subcontent">
                    ...
                    <form id="pform" class="stdform" action="" method="post" enctype="multipart/form-data">
                    	...
                    	<p>
                        	<label>套餐添加</label>
                            <span class="field">套餐名&nbsp; &nbsp;<input type="text" name="title0" class="smallinput" style="width:200px;" value="高级" />&nbsp; &nbsp;价格&nbsp; &nbsp;<input type="text" name="price0" value="<?php echo ((incprc($price0))?(incprc($price0)):''); ?>" class="smallinput" /><input type="hidden" name="id0" value="<?php echo (($id0)?($id0):''); ?>" /></span>
                            <span class="field">套餐名&nbsp; &nbsp;<input type="text" name="title1" class="smallinput" style="width:200px;" value="特级" />&nbsp; &nbsp;价格&nbsp; &nbsp;<input type="text" name="price1" value="<?php echo ((incprc($price1))?(incprc($price1)):''); ?>" class="smallinput" /><input type="hidden" name="id1" value="<?php echo (($id1)?($id1):''); ?>" /></span>
                            <span class="field">套餐名&nbsp; &nbsp;<input type="text" name="title2" class="smallinput" style="width:200px;" value="专家" />&nbsp; &nbsp;价格&nbsp; &nbsp;<input type="text" name="price2" value="<?php echo ((incprc($price2))?(incprc($price2)):''); ?>" class="smallinput" /><input type="hidden" name="id2" value="<?php echo (($id2)?($id2):''); ?>" /></span>
