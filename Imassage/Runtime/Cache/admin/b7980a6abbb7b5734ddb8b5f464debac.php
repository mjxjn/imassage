...
<div class="centercontent">
	<div class="pageheader">
            <h1 class="pagetitle">会员信息</h1>
            <span class="pagedesc">此页面用于编辑会员信息</span>
    </div><!--pageheader-->
    <div id="contentwrapper" class="contentwrapper">
    	<div id="basicform" class="subcontent">
                    ...
                    <form id="pform" class="stdform" action="" method="post">
                    	<p>
                        	<label>用户名</label>
                            <span class="field"><input type="text" name="name" id="name" disabled="disabled" value="<?php echo ($info["name"]); ?>" class="mediuminput" /></span>
                            <small class="desc">请输入按摩师名.</small>
                        </p>
                        <p>
                            <label>手机号</label>
                            <span class="field"><input type="text" name="phone" id="phone" disabled="disabled" value="<?php echo ($info["phone"]); ?>" class="mediuminput" /></span>
                            <small class="desc">请输入手机号.</small>
                        </p>
                        <p>
                            <label>余额</label>
                            <span class="field"><input type="text" name="money" id="money" value="<?php echo ($info["money"]); ?>" class="mediuminput" /></span>
                            <small class="desc">请输入账户余额.</small>
                        </p>
                        <p>
                            <label>用户地址</label>
                            <span class="field"><input type="text" name="address" id="address" value="<?php echo ($info["address"]); ?>" class="longinput" /></span>
                            <small class="desc">请输入用户地址.</small>
                        </p>
                        <p>
                        	<label>性别</label>
                            <span class="field">
